...
@RestController
@RequestMapping(value = "/rare")
public class RareMetalController {
    ...
    private void export(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
        ...
        // create excel sheet
        String sheetName = "稀贵金属";
        XSSFSheet sheet = (XSSFSheet) workbook.createSheet(sheetName);

        // create title row
        int rownum = 0;
        XSSFRow header = sheet.createRow(rownum++);
        String[] titles = new String[] { "日期", "品种", "规格", "最低价", "最高价", "涨跌", "升贴水最低价", "升贴水最高价", "单位" };
    ...
    private String getBrowser(HttpServletRequest request) {
        ...
        if (UserAgent.indexOf("safari") >= 0) return "Chrome";
        return "IE";
    }
    ...
    private List<List<String>> shanghaiSpot(int page) {
        String origin = "http://www.shmet.com/quotation/f-8.html%s";
        String url = "";
        if (page > 1) {
